...
export type Block = { type: "RichTextBlock"; props: RichTextProps } | { type: "TabsBlock"; props: TabsProps } | { type: "InteractiveBrainBlock"; props: InteractiveBrainProps } | { type: "BarChartBlock"; props: BarChartProps } | { type: "NavBlock"; props: NavProps }
...
export type InteractiveBrainProps = { id: string; groups: CommentGroup[] }
export type JSONContent = { content_type: string | null; attrs: any | null; content: JSONContent[] | null; marks: Mark[] | null; text: string | null; other: any }
...
export type Mark = { mark_type: string; attrs: any | null; other: any }
export type NavProps = { routes: ([string, string])[] }
...
export type RichText = { type: "Html"; data: string } | { type: "Tiptap"; data: JSONContent }
