...
//         risk_multiplier_lower: null,
//         risk_multiplier_higher: null,
//         explaination: "<p class=\"bn-inline-content\"></p><h3 class=\"bn-inline-content\">Major Depressive Disorder</h3><p class=\"bn-inline-content\">Approximately 50% of individuals with PTSD are reported to have MDD [3] [4]. Furthermore, comorbidity suggests an increased illness burden with a severe course of impairments and delay in treatment response. It is thought that depression may increase the risk of developing PTSD following a traumatic experience [15].</p>"
...
//         explaination: "<p class=\"bn-inline-content\"></p><h3 class=\"bn-inline-content\">Dementia</h3><p class=\"bn-inline-content\">Individuals with PTSD face a 1.55x higher risk of developing dementia [9]. The exact mechanisms linking PTSD to cognitive decline and dementia remain unclear [26]. However, research suggests that intrusive thoughts, a key symptom of PTSD, may predict cognitive impairment years later [26].</p>"
